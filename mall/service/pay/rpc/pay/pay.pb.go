...
var file_pay_proto_rawDesc = []byte{
	...
	0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x93, 0x02, 0x0a, 0x03, 0x50, 0x61,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x49, 0x0a, 0x0e, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b,
	0x52, 0x65, 0x76, 0x65, 0x72, 0x74, 0x12, 0x1a, 0x2e, 0x70, 0x61, 0x79, 0x63, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x2e, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x70, 0x61, 0x79, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x43,
	0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42,
	0x05, 0x5a, 0x03, 0x70, 0x61, 0x79, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_pay_proto_depIdxs = []int32{
	...
	4, // 3: payclient.Pay.CallbackRevert:input_type -> payclient.CallbackRequest
	1, // 4: payclient.Pay.Create:output_type -> payclient.CreateResponse
	3, // 5: payclient.Pay.Detail:output_type -> payclient.DetailResponse
	5, // 6: payclient.Pay.Callback:output_type -> payclient.CallbackResponse
	5, // 7: payclient.Pay.CallbackRevert:output_type -> payclient.CallbackResponse
...
func (c *payClient) CallbackRevert(ctx context.Context, in *CallbackRequest, opts ...grpc.CallOption) (*CallbackResponse, error) {
	out := new(CallbackResponse)
	err := c.cc.Invoke(ctx, "/payclient.Pay/CallbackRevert", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PayServer interface {
	...
	CallbackRevert(context.Context, *CallbackRequest) (*CallbackResponse, error)
}
...
func (*UnimplementedPayServer) CallbackRevert(context.Context, *CallbackRequest) (*CallbackResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CallbackRevert not implemented")
}
...
func _Pay_CallbackRevert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CallbackRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PayServer).CallbackRevert(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payclient.Pay/CallbackRevert",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PayServer).CallbackRevert(ctx, req.(*CallbackRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Pay_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CallbackRevert",
			Handler:    _Pay_CallbackRevert_Handler,
		},
	},
