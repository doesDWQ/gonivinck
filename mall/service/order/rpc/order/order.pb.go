...
var file_order_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x32, 0xd0, 0x03, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x41, 0x0a,
	...
	0x6e, 0x73, 0x65, 0x12, 0x41, 0x0a, 0x0a, 0x50, 0x61, 0x69, 0x64, 0x52, 0x65, 0x76, 0x65, 0x72,
	0x74, 0x12, 0x18, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e,
	0x50, 0x61, 0x69, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x50, 0x61, 0x69, 0x64, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x07, 0x5a, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x62,
...
var file_order_proto_depIdxs = []int32{
	...
	10, // 7: orderclient.Order.PaidRevert:input_type -> orderclient.PaidRequest
	...
	11, // 14: orderclient.Order.PaidRevert:output_type -> orderclient.PaidResponse
...
type OrderClient interface {
	...
	PaidRevert(ctx context.Context, in *PaidRequest, opts ...grpc.CallOption) (*PaidResponse, error)
}
...
func (c *orderClient) PaidRevert(ctx context.Context, in *PaidRequest, opts ...grpc.CallOption) (*PaidResponse, error) {
	out := new(PaidResponse)
	err := c.cc.Invoke(ctx, "/orderclient.Order/PaidRevert", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	PaidRevert(context.Context, *PaidRequest) (*PaidResponse, error)
}
...
func (*UnimplementedOrderServer) PaidRevert(context.Context, *PaidRequest) (*PaidResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PaidRevert not implemented")
}
...
func _Order_PaidRevert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PaidRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).PaidRevert(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orderclient.Order/PaidRevert",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).PaidRevert(ctx, req.(*PaidRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Order_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PaidRevert",
			Handler:    _Order_PaidRevert_Handler,
		},
	},
